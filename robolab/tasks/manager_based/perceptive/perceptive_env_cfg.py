...
"""Perceptive imitation: single NPZ motion + MotionCommand + depth camera."""
...
import robolab.tasks.manager_based.perceptive.mdp as mdp
...
@configclass
class PerceptiveSceneCfg(InteractiveSceneCfg):
...
class RewardsCfg:
    ...
    # anchor = motion root (torso_link); prioritize global tracking on terrain
...
class TerminationsCfg:
    ...
    out_of_border = DoneTerm(
        func=mdp.mesh_terrain_out_of_bounds,
        time_out=True,
        params={
...
@configclass
class PerceptiveEnvCfg(ManagerBasedRLEnvCfg):
